...
def test_add_new_pet_with_invalid_data_invalid_animal_type(name='Персик', animal_type='1568792855',
                                     age='4'):
    """Проверяем добавление питомца с  некорректными данными - неверными данными в animal_type """
...
def test_add_new_pet_with_valid_data(name='Персик', animal_type='двортерьер',
                                     age='4', pet_photo='images/cat1.jpg'):
    """Проверяем что можно добавить питомца с корректными данными"""
